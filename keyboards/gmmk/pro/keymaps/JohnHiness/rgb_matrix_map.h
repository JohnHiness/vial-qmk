 ...
 */
	...
	const uint8_t LED_LIST_CUST_SYMBOLS[] = { LED_MINS, LED_GRV, LED_EQL, LED_LEFT, LED_RIGHT, LED_UP, LED_DOWN, LED_RBRC, LED_COMM, LED_DOT, LED_LBRC, LED_SCLN, LED_QUOT, LED_SLSH, LED_BSLS, LED_XXX};
