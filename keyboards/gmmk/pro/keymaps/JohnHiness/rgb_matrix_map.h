 ...
 */
	...
	const uint8_t LED_LIST_CUST_NUM[] = { LED_1, LED_2, LED_3, LED_4, LED_5, LED_6, LED_7, LED_8, LED_9, LED_0, LED_PGUP, LED_PGDN, LED_HOME, LED_END};
	
	const uint8_t LED_LIST_CUST_SYMBOLS[] = { LED_MINS, LED_GRV, LED_EQL, LED_LEFT, LED_RIGHT, LED_UP, LED_DOWN, LED_RBRC, LED_COMM, LED_DOT, LED_LBRC, LED_SCLN, LED_QUOT, LED_SLSH, LED_SPC, LED_BSLS, LED_XXX};
	
	const uint8_t LED_LIST_CUST_MOD[] = { LED_LSFT, LEB_RCTL, LED_LCTL, LED_TAB, LED_ESC, LED_CAPS, LED_BSPC, LED_ENT, LED_ESC, LED_LGUI, LED_RSFT, LED_FN, LED_LALT, LED_RALT, LED_DEL};
