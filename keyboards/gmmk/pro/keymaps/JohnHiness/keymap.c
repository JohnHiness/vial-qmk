...
#define RGB_ROSE        0xFF, 0x00, 0x80
...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_FN1] = LAYOUT_iso(
        ...
        RGB_TOG, RGB_HUD, RGB_VAI, RGB_HUI, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, KC_NLCK, _______, _______,                   _______,
        KC_CAPS, RGB_SAD, RGB_VAD, RGB_SAI, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
        _______, _______, RGB_SPD, RGB_SPI, _______, _______, _______, _______, _______, _______, _______, _______,          _______, KC_PGUP, _______,
    ...
    [_MO2] = LAYOUT_iso(
        ...
        _______, _______, _______, _______, _______, _______, KC_TAB,  KC_P4,   KC_P5,   KC_P6,   KC_PDOT, _______, _______,                   _______,
        _______, _______, _______, _______, _______, _______, _______, KC_P1,   KC_P2,   KC_P3,   KC_NO,   KC_PAST, _______, KC_PENT,          _______,
    ...
    void rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
		...
		case _BASE:
			...
			for (uint8_t i=0; i<sizeof(LED_LIST_CUST_NUM)/sizeof(LED_LIST_CUST_NUM[0]); i++) {
                rgb_matrix_set_color(LED_LIST_CUST_NUM[i], RGB_BLUE);
            }
			...
			for (uint8_t i=0; i<sizeof(LED_LIST_CUST_MOD)/sizeof(LED_LIST_CUST_MOD[0]); i++) {
                rgb_matrix_set_color(LED_LIST_CUST_MOD[i], RGB_ROSE);
            }
			rgb_matrix_set_color(LED_FN, RGB_RED);
        ...
        case _MO2: // Numpad layer
            for (uint8_t i=0; i<sizeof(LED_LIST_NUMPAD)/sizeof(LED_LIST_NUMPAD[0]); i++) {
                rgb_matrix_set_color(LED_LIST_NUMPAD[i], RGB_WHITE);
            }
